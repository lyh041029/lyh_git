...
# 1. 创建HDFS目录
create_hdfs_dir("/warehouse/gmall_10/dwd/dwd_user_behavior_log")
...
STORED AS PARQUET
LOCATION '/warehouse/gmall_10/dwd/dwd_user_behavior_log'
...
dwd_user_behavior_log.write.mode("overwrite") \
    .partitionBy("dt") \
    .parquet("/warehouse/gmall_10/dwd/dwd_user_behavior_log")
...
print("验证DWD层数据:")
try:
    behavior_count = spark.sql("SELECT COUNT(*) as count FROM dwd_user_behavior_log WHERE dt = '20250808'").collect()[0]['count']
