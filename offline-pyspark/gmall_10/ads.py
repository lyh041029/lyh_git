...
print(f"开始处理gmall_10 ADS层数据，日期分区: {dt}")
...
# ====================== 页面流量分析看板 ======================
# 1. 创建HDFS目录
create_hdfs_dir("/warehouse/gmall_10/ads/ads_page_traffic_dashboard")
...
STORED AS PARQUET
LOCATION '/warehouse/gmall_10/ads/ads_page_traffic_dashboard'
...
ads_traffic_dashboard.write.mode("overwrite") \
    ...
    .partitionBy("dt") \
    .parquet("/warehouse/gmall_10/ads/ads_page_traffic_dashboard")
...
# ====================== 页面点击分布看板 ======================
# 1. 创建HDFS目录
create_hdfs_dir("/warehouse/gmall_10/ads/ads_page_click_dashboard")
...
PARTITIONED BY (dt string COMMENT '统计日期')
STORED AS PARQUET
LOCATION '/warehouse/gmall_10/ads/ads_page_click_dashboard'
TBLPROPERTIES ('parquet.compress' = 'SNAPPY')
""")
...
ads_click_dashboard.write.mode("overwrite") \
    ...
    .option("parquet.writeLegacyFormat", "true") \
    .partitionBy("dt") \
    .parquet("/warehouse/gmall_10/ads/ads_page_click_dashboard")
...
# ====================== 页面引导效果看板 ======================
# 1. 创建HDFS目录
create_hdfs_dir("/warehouse/gmall_10/ads/ads_page_guidance_dashboard")
...
PARTITIONED BY (dt string COMMENT '统计日期')
STORED AS PARQUET
LOCATION '/warehouse/gmall_10/ads/ads_page_guidance_dashboard'
TBLPROPERTIES ('parquet.compress' = 'SNAPPY')
""")
...
ads_guidance_dashboard.write.mode("overwrite") \
    ...
    .option("parquet.writeLegacyFormat", "true") \
    .partitionBy("dt") \
    .parquet("/warehouse/gmall_10/ads/ads_page_guidance_dashboard")
...
# ====================== 综合页面分析看板 ======================
# 1. 创建HDFS目录
create_hdfs_dir("/warehouse/gmall_10/ads/ads_comprehensive_page_analysis")
...
PARTITIONED BY (dt string COMMENT '统计日期')
STORED AS PARQUET
LOCATION '/warehouse/gmall_10/ads/ads_comprehensive_page_analysis'
TBLPROPERTIES ('parquet.compress' = 'SNAPPY')
""")
...
comprehensive_analysis.write.mode("overwrite") \
    ...
    .option("parquet.writeLegacyFormat", "true") \
    .partitionBy("dt") \
    .parquet("/warehouse/gmall_10/ads/ads_comprehensive_page_analysis")
