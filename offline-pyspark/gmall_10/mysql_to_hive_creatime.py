...
# -------------------------- 配置项（在此处修改库名和连接信息） --------------------------
# 直接修改以下两个参数即可指定同步的库名
MYSQL_DB = "gmall_10"  # MySQL数据库名
HIVE_DB = "gmall_10"  # Hive数据库名
...
DEFAULT_MYSQL_CONFIG = {
    ...
    "user": "root",
    "password": "root",
    "database": "gmall_10"  # 关联上面的MySQL库名
}
...
def create_spark_session(hive_config):
    """创建Spark会话"""
    jdbc_jar = r"G:\dashuju\zhuangao6\周涵专高6资料\cdh\06Mysql\mysql-connector-java-5.1.27-bin.jar"
